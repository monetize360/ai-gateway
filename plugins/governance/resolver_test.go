...
func TestBudgetResolver_EvaluateRequest_VirtualKeyNotFound(t *testing.T) {
	...
	result := resolver.EvaluateVirtualKeyRequest(ctx, "vk-missing", schemas.OpenAI, "gpt-4", schemas.ChatCompletionRequest, false)
...
func TestBudgetResolver_EvaluateRequest_ModelBlocked(t *testing.T) {
	...
	result := resolver.EvaluateVirtualKeyRequest(ctx, "vk1", schemas.OpenAI, "gpt-4o-mini", schemas.ChatCompletionRequest, false)
