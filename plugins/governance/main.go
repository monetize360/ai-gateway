...
// SetKVStore is retained for transport wiring compatibility. Classification
// caching was removed with the NVIDIA/lexical path; the store is unused.
func (p *GovernancePlugin) SetKVStore(_ *kvstore.Store) {}
