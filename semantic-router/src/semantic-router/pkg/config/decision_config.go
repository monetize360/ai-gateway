...
type Decision struct {
	...
	// CapabilityProfile declares required/preferred model qualities when the
	// decision does not pin modelRefs. Preview returns it so a caller can
	// select from a live inventory.
	CapabilityProfile   *CapabilityProfile         `yaml:"capability_profile,omitempty" json:"capability_profile,omitempty"`
