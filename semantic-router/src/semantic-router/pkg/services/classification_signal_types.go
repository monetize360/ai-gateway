...
const (
	...
	EvalSelectionProfileOnly       = "profile_only"
...
type EvalResponse struct {
	...
	CapabilityProfile      *config.CapabilityProfile               `json:"capability_profile,omitempty"`
	SelectionStatus        string                                  `json:"selection_status,omitempty"` // selected, planned_final, fallback, execution_required, not_required, profile_only, unavailable, or failed
